export default function Contact() {
  return (
    <section
      id="contact"
      className="min-h-[100svh] snap-start [scroll-snap-stop:always] flex items-center py-16 sm:py-24 md:py-32 bg-white"
    >
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 text-center">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium tracking-tight text-[#1F2A36] mb-8 sm:mb-12 animate-fade-up anim-delay-100 parallax-text">
          Say hello
        </h2>
        <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-6 sm:gap-8 md:gap-12 text-sm sm:text-base md:text-lg font-light text-[#4A4F55] text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start gap-2 sm:gap-3 w-full md:w-auto max-w-sm">
