  ...
  return (
    <Section id="news">
        <div className="mb-8 sm:mb-12 md:mb-16 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium tracking-tight text-[#d4af37] animate-fade-up anim-delay-100 parallax-text">Latest News</h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
          {newsItems.map((item, index) => (
            <article
              key={index}
              className="bg-white shadow-[0_0_20px_rgba(15,23,42,0.10)] hover:shadow-[0_0_20px_rgba(15,23,42,0.12)] rounded-md transition-all duration-300 flex flex-col animate-scale-in overflow-hidden"
