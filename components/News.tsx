  ...
  return (
    <Section id="news">
        <div className="flex justify-between items-center mb-8 sm:mb-12 md:mb-16">
          <h2 className="text-2xl sm:text-3xl font-medium tracking-tight text-[#1F2A36]">Latest News</h2>
        </div>
        ...
        <div className="flex flex-col gap-px bg-[#D9D9D9] border border-[#D9D9D9]">
          {newsItems.map((item, index) => (
            <article
              key={index}
              className="bg-white hover:bg-white p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col md:flex-row gap-4 sm:gap-6 md:items-center justify-between transition-colors"
            >
